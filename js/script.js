...
function showTab(n) {
  ...
  if (n == 0) {
    ...
    document.getElementById("part_type").innerHTML = "ESSAY TEST";
    document.getElementById("prevBtn").style.display = "inline";
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
    if (confirm("Your application will be sent to Continental Rental and Tours, Inc. You will be notified by our Human Resource Personnel upon the approval of your application. Thank you and have a nice day!")) {
